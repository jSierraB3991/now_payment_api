...
type NowPaymentServiceInterface interface {
	...
	GetInvoiceDataService(ctx context.Context, page, limit int, isAscendente bool, params []eliotlibs.PagginationParam) ([]nowpaymentsmodel.NowPaymentCreateInvoice, error)
