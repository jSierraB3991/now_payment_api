...
type NowPaymentServiceInterface interface {
	...
	GetInvoiceDataService(ctx context.Context, page *eliotlibs.Paggination, params []eliotlibs.PagginationParam) (*nowpaymentsresponse.InvoiceDataResponsePagg, error)
